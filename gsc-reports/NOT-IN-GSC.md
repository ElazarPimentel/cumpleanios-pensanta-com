...
## Expected Site URL
`https://cumpleanios.pensanta.com`

## Full Automated Workflow to Add Site to GSC

### Step 1: Get Verification Token
```python
mcp__gsc__get_verification_token(site_url="https://cumpleanios.pensanta.com")
```
...
```python
mcp__gsc__verify_site(site_url="https://cumpleanios.pensanta.com")
```

### Step 5: Add to Search Console
```python
mcp__gsc__add_site(site_url="sc-domain:cumpleanios.pensanta.com")
```

### Step 6: Submit Sitemap
```python
mcp__gsc__submit_sitemap(
    site_url="sc-domain:cumpleanios.pensanta.com",
    sitemap_url="https://cumpleanios.pensanta.com/sitemap.xml"
)
```
